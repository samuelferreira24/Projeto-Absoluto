...
def test_interface_exposes_tool_planning_discovery_and_voice_controls():
    ...
    for marker in ("/tools/knowledge", "/tools/plan", "/resources/dispatch", "/tools/discover", "SpeechRecognition", "Conversa com uma IA", "Sala de Inteligências", "room-ai", "abs-chat-history", "MAPA ABS", "absMap", "data-depth", "abs-node"):
        assert marker in html
