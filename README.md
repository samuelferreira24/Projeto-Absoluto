...
Repositório principal da construção atual do Projeto Absoluto.

## Estrutura principal

- `abs_core/` — runtime ABS V1.
- `cerebro/` — cérebro atual: estado, dados, especificações, mapas e testes.
- `mini-cerebro/` — componente histórico/arquitetural separado.
